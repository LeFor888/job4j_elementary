...
public class DefragmentTest {
    ...
    @Test
    public void randomNull() {
        String[] input = {null, "I", null, null, "wanna",  null, "be", null, "compressed"};
    ...
    @Test
    public void allMiddleNull() {
        String[] input = {"I", "wanna", null, null, null, "be", "compressed"};
        String[] compressed = Defragment.compress(input);
